            ...
            if ( in_array($numeroSorteado, $bolao[$aposta])) {
                ...
                switch($bolao[$aposta][5]) {
                    ...
                    case 1:
                        ...
                        break; 
                    case 2:
                        $bolao[$aposta][6] = "*** APOSTA PREMIADA*** - DUQUE";
                        break; 
                    case 3:
                        $bolao[$aposta][6] = "*** APOSTA PREMIADA*** - TERNO";
                        break; 
                    case 4:
                        $bolao[$aposta][6] = "*** APOSTA PREMIADA*** - QUADRA";
                        break;
                    case 5:
                        $bolao[$aposta][6] = "*** APOSTA PREMIADA*** - QUINA";
                    break;              
                }                                                
