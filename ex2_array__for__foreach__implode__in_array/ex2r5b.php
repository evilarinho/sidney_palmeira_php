<?php
    ...
    */
    ...
    $boletim = array( array('CSS', 5.00, 6.00, 0.00, "NÃO AVALIADO"),
    ...
    for ($i = 0; ($i < count($boletim)); $i++) {
        $boletim[$i][3] = ($boletim[$i][1] + $boletim[$i][2]) / 2; 
        if ( $boletim[$i][3] < 5) {
            $boletim[$i][4] = "REPROVADO";
        } else if ( $boletim[$i][3] < 7) {
            $boletim[$i][4] = "EM EXAME";            
        } else {
            $boletim[$i][4] = "APROVADO";
        }
    }
    //var_dump($materias);
    ...
    for ($i = 0; ($i < count($boletim)); $i++) {        
        ...
        echo $boletim[$i][0];
        //echo str_repeat(" ", 6);
        echo "      " . number_format($boletim[$i][1], 2,'.', '');
        echo str_repeat(" ", 6);
        echo number_format($boletim[$i][2], 2,'.', '');
        echo str_repeat(" ", 6);
        echo number_format($boletim[$i][3], 2,'.', '');
        echo str_repeat(" ", 6);
        echo $boletim[$i][4];
        echo str_repeat(" ", 6);              
        echo "\n"; 
